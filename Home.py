...
<div class="profile-card">
    ...
    <div class="profile-info">
        ...
        <p style="color:rgba(255,255,255,0.85); font-size:0.92rem; margin: 0.4rem 0 0.8rem 0;">
            <strong>기초 통계를 넘어선 심층 사회통계분석으로, 비즈니스의 실행 가능한 해답을 찾습니다.</strong><br/><br/>
            심리학 기반의 정교한 사회통계 지식을 바탕으로 데이터의 노이즈를 걷어내고 진짜 인사이트를 발굴합니다. 
            클러스터링을 통한 비지도 학습 패턴 발견부터, PSM·OW 기반의 엄밀한 인과추론까지 아우르며, '현상 파악'에 머물지 않고 '어떤 액션을 취해야 하는가'에 대한 객관적인 기준을 도출합니다.
        </p>
