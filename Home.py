        ...
        <div class="profile-cols">
            ...
            <div class="profile-col">
                ...
                <details style="margin-bottom:0.3rem;">
                    <summary style="cursor:pointer; list-style:none;">📜 사회조사분석사 2급</summary>
                        <span style="font-size:0.75rem; opacity:0.5;">▶ 클릭</span>
                    </summary>
                    <img src="data:image/png;base64,{cert1_b64}" style="width:400px; margin-top:0.5rem; border-radius:0.5rem;">
                </details>
                <details style="margin-bottom:0.3rem;">
                    <summary style="cursor:pointer; list-style:none;">📜 직업상담사 2급</summary>
                        <span style="font-size:0.75rem; opacity:0.5;">▶ 클릭</span>
                    </summary>                    
                    <img src="data:image/png;base64,{cert2_b64}" style="width:400px; margin-top:0.5rem; border-radius:0.5rem;">
                </details>
                <details style="margin-bottom:0.3rem;">
                    <summary style="cursor:pointer; list-style:none;">📜 청소년상담사 3급</summary>
                        <span style="font-size:0.75rem; opacity:0.5;">▶ 클릭</span>
                    </summary>                    
            ...
            <div class="profile-col">
                <h4>경력</h4>
                <details style="margin-bottom:0.3rem;">
                    <summary style="cursor:pointer; list-style:none;">🏢 테슬라 | 인턴 (2024.02 ~ 2024.05)</summary>
                        <span style="font-size:0.75rem; opacity:0.5;">▶ 클릭</span>
                    </summary>                    
                ...
                <details style="margin-bottom:0.3rem;">
                    <summary style="cursor:pointer; list-style:none;">🏢 스파르타 내일배움캠프 데이터분석가 과정 | 학생 (2025.10 ~ 2026.3)</summary>
                        <span style="font-size:0.75rem; opacity:0.5;">▶ 클릭</span>
                    </summary>                    
                    <div style="margin-top:0.5rem; font-size:0.85rem; opacity:0.85; line-height:1.7;">
