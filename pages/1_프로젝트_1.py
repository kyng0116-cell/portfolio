...
if tab == "💡 인사이트":
    ...
    st.markdown("""<div class="section-box"><h3>분석 배경 및 목적</h3><br/><p><strong>거시적 경제 위기:</strong> 2026년 한국 경제성장률이 $1.9%$로 전망되며, 구조적 저성장인 'L자형 침체'가 고착화되는 국면입니다. 
                이에 따라 소비자들이 필수재 외의 지출을 줄이는 상황입니다.
                <strong>다이소 뷰티의 역설적 성장:</strong> 불황 속에서도 다이소 뷰티 카테고리는 144% 성장하며 전체 매출의 약 10%(4,000억 원 규모)를 차지하는 핵심 동력으로 부상했습니다.
                <strong>신뢰 자산의 위기:</sgtrong> '스텐 세정제 납 검출' 사건과 C-커머스(알리, 테무)의 유해 물질 이슈가 맞물리며 '초저가 제품은 위험하다'는 부정적 프레임이 형성되었습니다.
                <strong>전략적 목적:</strong> 단순 가성비를 넘어 '데이터 기반의 품질 안전'과 '고객 맞춤형 효율화'를 통해 2026년의 구조적 위기를 돌파하고 초격차 성장을 달성하는 것입니다.</p></div>""", unsafe_allow_html=True)
